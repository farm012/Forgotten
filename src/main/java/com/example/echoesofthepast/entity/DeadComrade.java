...
public class DeadComrade extends Zombie {
    ...
    private boolean isHallucination = false;

    public void setHallucination(boolean value) {
        this.isHallucination = value;
    }
    ...
    public net.minecraft.world.entity.SpawnGroupData finalizeSpawn(
        ...
        this.entityData.set(VARIANT, this.random.nextInt(5));
        return result;
    }
    ...
    public void tick() {
        super.tick();
        if (isHallucination && !this.level().isClientSide() && this.tickCount > 40) {
            this.discard();
        }
    }
