...
public class DeadComradeRenderer extends ZombieRenderer {
    private static final Identifier[] TEXTURES = {
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_0.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_1.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_2.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_3.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_4.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/dead_comrade_5.png")
    };
