...
public class TombGuardianRenderer extends ZombieRenderer {
    private static final Identifier[] TEXTURES = {
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/tomb_guardian_0.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/tomb_guardian_1.png"),
            Identifier.fromNamespaceAndPath("echoesofthepast", "textures/entity/tomb_guardian_2.png")
    };
